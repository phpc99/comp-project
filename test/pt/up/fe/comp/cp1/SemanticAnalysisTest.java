...
public class SemanticAnalysisTest {
    ...
    public void VarargsArray() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/VarargsArray.jmm"));
        TestUtils.noErrors(result);
    }

    @Test
    public void ThisStaticWrong() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/ThisStaticWrong.jmm"));
        TestUtils.mustFail(result);
    }
    @Test
    public void VarargsDecl() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/VarargsDecl.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }
    @Test
    public void VarargsField() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/VarargsField.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }
    @Test
    public void arrayAssignmentWrong() {
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/ArrayAssignmentWrong.jmm"));
        TestUtils.mustFail(result);
    }
    @Test
    public void BinaryOperationMethodCall1() {
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/BinaryOperationMethodCall1.jmm"));
        TestUtils.noErrors(result);
    }
    @Test
    public void BinaryOperationMethodCall2() {
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/BinaryOperationMethodCall2.jmm"));
        TestUtils.mustFail(result);
    }
