...
public class JmmAnalysisImpl implements JmmAnalysis {
    ...
    private List<AnalysisVisitor> buildPasses(SymbolTable table) {
        List<AnalysisVisitor> visitors = new ArrayList<>();

        visitors.add(new UndeclaredVariable());
        visitors.add(new BinaryExprType());
        visitors.add(new MethodReturnType());
        visitors.add(new ArrayAccess());
        visitors.add(new ConditionType());
        visitors.add(new AssignmentCheckType());
        visitors.add(new ArrayCheckType());
        visitors.add(new ArgumentsCheck());
        visitors.add(new MethodCheck());
        visitors.add(new ThisCheck());
